...
```{r}
xeno <- qs::qread("./input_data/xeno.qs")
hif_targets = scan("./input_data/HIF_targets_Lombardi_PMC9869179.txt", character(), quote = "")
genesets = getGmt("./input_data/h.all.v2023.2.Hs.symbols.gmt") %>% geneIds()
genesets[["HIF_targets"]] = hif_targets
all_metagenes = readRDS("./input_data/cell_usage_by_TPM.RDS")
gep_scores = readRDS("./input_data/gep_scores.RDS")
```



```{r fig.height=6, fig.width=14}
xeno$orig.ident = paste0("MGH",xeno$orig.ident)
...
p = ggarrange(plotlist = plotlist[1:4],common.legend = T,nrow = 2,ncol = 2)
p
```
