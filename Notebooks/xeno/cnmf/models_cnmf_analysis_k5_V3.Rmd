...
plot_path = "./processed_data/cnmf_V2/noTPM_100iter/BatchCorrected_cnmf/BatchCorrected_cnmf.k_selection.png"
...
for (model in unique(xeno$orig.ident)) {
  ...
  # line plots
  data = FetchData(object = model_data, vars = paste0("Program.", 1:4))
  # data = data[1:100, ]
  col_dend = hclust(dist(data), method = "complete")
  data = data[col_dend$order, ]
  data$cell = 1:nrow(data)
  d <- reshape2::melt(data, id = "cell")
