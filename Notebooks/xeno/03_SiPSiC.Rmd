...
for (patient_name in unique(xeno$orig.ident)) {
  ...
  patient_data = patient_data[,colnames(patient_data)[! patient_data$treatment == "res"]]
...
# geom_point(ggtern::aes(fill=treatment,color=treatment),alpha = 0.5) +
scale_shape_manual(values=c(21,22),breaks = c("OSI"))+
    ggtitle(paste("Model",patient_name))+
  theme_tropical(base_size=14) +
 stat_density_tern(geom='DensityTern',ggtern::aes(color=treatment,alpha = 0.6))
...
#     ggtitle(paste("Model",patient_name))+
#   theme_tropical(base_size=14) +
#  stat_density_tern(geom='polygon',ggtern::aes(fill=treatment,alpha=..level..))
# 
...
#     ggtitle(paste("Model",patient_name))+
#   theme_tropical(base_size=14) +
#  stat_density_tern(geom='polygon',ggtern::aes(fill=treatment,alpha = 0.5))
