---
title: 'Patients sipsic analysis' 
...
source("./pipe.R")
input = pipeline$patients_sipsic_analysis$input
output = pipeline$patients_sipsic_analysis$output
```
...
```{r}
svg(params$data_out_dir %s+% "patients_sipsic_heatmap.svg",height = 9,width = 10)
p
dev.off()
```
