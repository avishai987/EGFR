...
tiss_subset_tumor2$treatment = tiss_subset_tumor2$analysis
tiss_subset_tumor2@meta.data[["analysis"]] = factor(tiss_subset_tumor2$analysis, levels = c("naive", "grouped_pr","grouped_pd"))
```
...
FeaturePlot(object = tiss_subset_tumor2,features = colnames(all_metagenes),ncol = 3)+DimPlot(object = tiss_subset_tumor2,group.by = "analysis")
