...
names (osiRoxaJun23) = gsub(x = names(osiRoxaJun23),pattern = "op",replacement = "osiPersistors")%>% gsub(pattern = "cp",replacement = "comboPersistors") 
osiRoxaJun23 = osiRoxaJun23[,1:15]
