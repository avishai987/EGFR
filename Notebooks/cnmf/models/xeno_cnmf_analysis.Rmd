...
if (by_expression){
  ...
  all_metagenes = expression_mult(gep_scores = gep_scores,dataset = xeno,top_genes = T,max_genes = F,min_max  = F )
...
```{r}
DimPlot(xeno,group.by = "program.assignment",cols = c("red","green","blue","grey"))
...
```{r warning=FALSE}
FeaturePlot(object = xeno,features = "metagene.3")

FeaturePlot(object = xeno,features = hallmark_name)
```
