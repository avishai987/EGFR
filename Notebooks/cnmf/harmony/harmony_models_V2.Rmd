...
adata = sc.read_h5ad('/sci/labs/yotamd/lab_share/avishai.wizel/R_projects/EGFR/Data/xeno_counts.h5ad')
```
...
xeno_corr_nonneg <- RunUMAP(xeno_corr_nonneg, dims = 1:15)
...
```{r fig.height=4, fig.width=10}
xeno_corr_nonneg <- RunUMAP(xeno_corr_nonneg, dims = 1:5)
DimPlot(xeno_corr_nonneg, reduction = "umap",group.by = "orig.ident",shuffle = T)+
  DimPlot(xeno_corr_nonneg, reduction = "umap",group.by = "treatment",shuffle = T)
```
