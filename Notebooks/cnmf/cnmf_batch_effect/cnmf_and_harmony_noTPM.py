...
# python cnmf_and_harmony_noTPM.py
...
cnmf_obj_corrected = cNMF(output_dir='/sci/labs/yotamd/lab_share/avishai.wizel/R_projects/EGFR/Data/cnmf_V2/noTPM/', name='BatchCorrected_cnmf')
cnmf_obj_corrected.prepare(counts_fn='/sci/labs/yotamd/lab_share/avishai.wizel/R_projects/EGFR/Data/cnmf_V2/noTPM/xeno_batchCorrect.Corrected.HVG.Varnorm.h5ad', genes_file='/sci/labs/yotamd/lab_share/avishai.wizel/R_projects/EGFR/Data/cnmf_V2/noTPM/xeno_batchCorrect.Corrected.HVGs.txt',components=np.arange(3,11), n_iter=20, seed=14, num_highvar_genes=2000)
...
print ("done...")
import pickle
f = open('/sci/labs/yotamd/lab_share/avishai.wizel/R_projects/EGFR/Data/cnmf_V2/noTPM/models_2Kvargenes_corrected_noTPM_cnmf_obj.pckl', 'wb')
