...
import pickle
f = open('./Data/cnmf_V2/noTPM/models_2Kvargenes_corrected_noTPM_cnmf_obj.pckl', 'rb')
...
plot_path = paste0("/sci/labs/yotamd/lab_share/avishai.wizel/R_projects/EGFR/Data/cnmf_V2/BatchCorrected_cnmf/cnmf_tmp/")
...
plotlist[[2]] = plotlist[[2]] +scale_x_discrete(expand = expansion(add = c(1,2)))
