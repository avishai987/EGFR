...
cowplot::plot_grid(xeno_nmf_usage_UMAP,as.grob(xeno_nmf_heatmap),ncol = 1,labels = "AUTO")
```
```{r}
pdf("./final_figures/fig2.pdf",width = 12,height = 17)
cowplot::plot_grid(xeno_nmf_usage_UMAP,xeno_nmf_heatmap,ncol = 1,labels = "AUTO")
dev.off()
```
# Figure 3
...
bivona_nmf_split_violin = readRDS("./Figures/bivona_nmf_split_violin.rds")
...
p1 = cowplot::plot_grid(bivona_nmf_usage_umap,patients_nmf_usage_umap, bivona_nmf_dotplot,patients_nmf_usage_dotplot,bivona_nmf_split_violin,patients_nmf_hypoxia_violin,nrow = 3, ncol = 2,labels = "AUTO",rel_heights = c(1.5,1,1))
...
bivona_known_genes_violin = readRDS("./Figures/bivona_known_genes_violin.rds")
